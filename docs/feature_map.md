...
Last updated: 2026-08-25 (minimal OpenCode memory injection observability, Edit Alignment semantics, project binding-norm subsystem; digest backlog + digest-conclusion feedback; prompt-time habit perceptibility with CJK-aware relevance and scope routing)
