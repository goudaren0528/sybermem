 ...
 * Source: packages/opencode-plugin/src/v1.ts
 * Regenerate with: bun scripts/build-opencode-plugin.mjs --v1
 * Do not edit this file by hand; V1 compatibility plugin.
 */
// @bun
